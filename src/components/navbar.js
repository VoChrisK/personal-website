...
const Navbar = () => {
    return (
        <nav className="navbar" data-sal="slide-down" data-sal-easing="ease" data-sal-duration="500" data-sal-delay="500">
            <a href="https://chrisvo.dev/"><img className="cv-logo" src={require("./../../images/cv-logo.png")} /></a>
            <ul className="links">
                ...
                <li className="link-content" data-sal="slide-down" data-sal-easing="ease" data-sal-duration="500" data-sal-delay="800"><button onClick={() => scrollTo("#contact")} href="#">Contact</button></li>
            </ul>
        </nav>
    );
};
