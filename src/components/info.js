    ...
    return (
        <nav className="info-navbar" >
            <ul className="links">
                ...
                <li data-sal="slide-up" data-sal-easing="ease" data-sal-duration="500" data-sal-delay="700"><a href={require('./../../assets/resume.pdf')} target="_blank"><i className="resume"></i></a></li>
            </ul>
